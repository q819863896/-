...
let routes = [
   ...
   //    children: [
   //       { path: '/collaborate', component: COLLABORATE, name: '上传excel' },
   //    ],
   // },
   {
      path: '/',
      ...
      children: [
         { path: '/academy', component: ACADEMY, name: '上传excel' },
      ],
   },
   {
      path: '/',
      ...
      iconCls: 'iconfont icon-gongsi',
      children: [
         { path: '/projieshao', component: projieshao, name: '项目介绍pdf' },
      ],
   },
   {
      path: '/',
      ...
      iconCls: 'iconfont icon-gongsi',
      children: [
         { path: '/studentfeedback', component: studentfeedback, name: '学生反馈pdf' },
      ],
   },
   {
      path: '/',
